package com.akotnana.gradeview.fragments.gradebook;
...
import com.akotnana.gradeview.utils.adapters.RVAdapterGrade;
import com.akotnana.gradeview.utils.cards.GradeCourseCard;
                ...
                BackendUtils.doGetRequest("/grades/quarter/" + quarterIndex + "/", new HashMap<String, String>() {{
                    ...
                    public void onSuccess(String result) {
                        ...
                        if(courses.length < 1) {
                            ...
                            errorSnack = Snackbar.make(((Activity) getContext()).findViewById(android.R.id.content), "There are currently no grades for this quarter", Snackbar.LENGTH_LONG);
                            errorSnack.setAction("Dismiss", new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    errorSnack.dismiss();
